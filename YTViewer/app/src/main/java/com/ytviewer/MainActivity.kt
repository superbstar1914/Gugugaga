...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Handle intent (e.g. shared from YouTube app)
        handleIntent(intent)
    }
    ...
    private fun updateThemeIcon() {
        binding.btnTheme.setIconResource(
